...
public class Repository {
	...
	public Result add(String... files) {
		...
		return new Result("added " + str.toString().substring(0, str.length() - 2) + " to stage", true);
	}
	...
	public Result remove(String... files) {
		...
		return new Result("added " + str.toString().substring(0, str.length() - 2) + " for removal", true);
